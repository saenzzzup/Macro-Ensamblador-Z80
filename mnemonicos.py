...
#MappnngOpcodes
map_mnem={
 "LD A,A": LDAA, "LD A,B": LDAB, "LD A,C":LDAC, "LD A,NN": LDANN, "JP nn":JPNN,
 "LD A,n": LDAN, "LD A,(nn)": LDANN, "LD (IX+d),n": LDIXdN, "LD (IY+d),n": LDIYdN,
